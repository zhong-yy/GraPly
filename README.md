...
[![DOI](https://zenodo.org/badge/146179778.svg)](https://zenodo.org/badge/latestdoi/146179778)
...
![](http://latex.codecogs.com/gif.latex?\\rho=a_{000}+a_{100}x+a_{010}y+a_{001}z+a_{200}x^2+a_{020}y^2+a_{002}z^2+a_{101}xz+a_{011}yz+a_{110}xy+a_{003}z^3+a_{012}yz^2+a_{021}y^2z+a_{030}y^3+a_{102}xz^2+a_{111}xyz+a_{120}xy^2+a_{201}x^2z+a_{210}x^2y+a_{300}x^3)
